...
The following code snippets will create the front end for the application. You can modify these code snippets as you like.
...
```
**Step 2:** Create the file lib/features/trip/ui/trips_list/trip_card.dart and update it with the following code: 
...
**Step 3:** Go back to the file lib/features/trip/ui/trips_list/trips_list_page.dart and update it with the following code:
